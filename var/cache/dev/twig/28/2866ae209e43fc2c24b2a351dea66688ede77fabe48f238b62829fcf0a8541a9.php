...
class __TwigTemplate_3f0c83cc8d3f326453c5050242e2f562e0d4f18409b6a2fe3aaefb473635252e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <h1>Hola ";
        // line 11
        echo twig_escape_filter($this->env, (isset($context["usuario"]) || array_key_exists("usuario", $context) ? $context["usuario"] : (function () { throw new RuntimeError('Variable "usuario" does not exist.', 11, $this->source); })()), "html", null, true);
        echo " </h1>
    ...
    <p>
        <a href=\"";
        // line 18
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((("http://www.rasprivate.es/nuevapass" . "?token=") . (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 18, $this->source); })()))), "html", null, true);
...
";
    ...
    {
        return array (  164 => 28,  160 => 27,  156 => 26,  151 => 25,  141 => 24,  126 => 18,  116 => 11,  113 => 10,  103 => 9,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% block body %}
    ...
    <p>
        <a href=\"{{ asset('http://www.rasprivate.es/nuevapass' ~ '?token=' ~ token) }}\">Establece tu nueva contraseña</a>
    </p>
...
{% endblock %}", "email/email.html.twig", "C:\\xampp\\htdocs\\proyecto\\templates\\email\\email.html.twig");
    }
}
